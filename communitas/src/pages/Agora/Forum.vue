        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="ibox-content m-b-sm border-bottom">
                    <div class="p-xs">
                        <div class="float-left m-r-md mr-4">
                            <i class="fa fa-globe text-navy mid-icon"></i>
                        </div>
                        <h2>Welcome in DemoDAO Forum</h2>
                        <span class='pl-1'>Feel free to choose topic you're interested in.</span>
                    </div>
                </div>

                <div class="ibox-content forum-container mt-3">
